...
export default function Home() {
  ...
  const handleStart = () => router.push('graph')
  return (
    <div className="text-center min-h-screen flex flex-col justify-center items-center">
      ...
      <input type="text" placeholder="WRITE YOUR TOPIC" className="w-80 p-3 mb-4 border rounded-md text-lg" />
      ...
      <button className="w-80 p-3 bg-gray-400 rounded-md text-lg" onClick={handleStart}>
        start
      </button>
    </div>
  )
