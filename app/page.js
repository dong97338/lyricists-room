...
export default () => {
  ...
  return (
    <>
      ...
      <input type="text" placeholder="키워드를 입력해주세요.. 한 단어일수록 좋아요!" className="mb-4" value={topic} onChange={e => setTopic(e.target.value)} />
      <input type="text" placeholder="키메시지를 입력해주세요!" className="mb-4" value={key} onChange={e => setKey(e.target.value)} />
